...
Now with your editor of choice, look for the `prometheus.yaml` key entry and replace it with [OSM's scraping config](https://github.com/openservicemesh/osm/blob/release-v1.0/charts/osm/templates/prometheus-configmap.yaml) (proceed with care while formatting the yaml file):
```
  (....)
  prometheus.yml: |
    global:
...
- [our repository](https://github.com/openservicemesh/osm/tree/release-v1.0/charts/osm/grafana), and are importable as json blobs through the web admin portal
