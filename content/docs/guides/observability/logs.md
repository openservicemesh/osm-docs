...
1. Install OSM with Fluent Bit enabled:
    ...
    osm install --set=OpenServiceMesh.enableFluentbit=true
    ```
> NOTE: Ensure that the [Fluent Bit image tag](https://github.com/openservicemesh/osm/blob/release-v0.10/charts/osm/values.yaml) is `1.6.4` or greater as it is required for this feature.
