...
| spec.sidecar.initContainerImage | string | `"openservicemesh/init:v0.11.1"` | `kubectl patch meshconfig osm-mesh-config -n osm-system -p '{"spec":{"sidecar":{"initContainerImage":"openservicemesh/init:v0.11.1"}}}' --type=merge` |
