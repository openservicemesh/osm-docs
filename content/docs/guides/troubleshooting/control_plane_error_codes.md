...
|            | manager.                                                                         |
+------------+----------------------------------------------------------------------------------+
| E4015      | The certificate authority provided when issuing a certificate was invalid.       |
+------------+----------------------------------------------------------------------------------+
...
|            | received. The Stream Aggregated Resource server was terminated for the specified |
|            | proxy.                                                                           |
+------------+----------------------------------------------------------------------------------+
