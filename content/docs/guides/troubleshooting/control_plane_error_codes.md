...
+------------+----------------------------------------------------------------------------------+
| E3008      | The Ingress API versions supported by the k8s API server could not be obtained.  |
+------------+----------------------------------------------------------------------------------+
...
|            | received.  The Stream Aggregated Resource server was terminated for the          |
|            | specified proxy.                                                                 |
+------------+----------------------------------------------------------------------------------+
