...
- [1:1 relationship](<https://en.wikipedia.org/wiki/One-to-one_(data_model)>) between an [endpoint](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#fgh-endpoint) (port and IP) and a [proxy](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#a-proxy)

### Proxy Control Plane

The [Proxy control plane](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#1-proxy-control-plane) handles gRPC connections from the service mesh sidecar proxies and implements Envoy's `go-control-plane`.
...
The [Endpoints providers](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) component provides abstractions around the Go
SDKs of various Kubernetes clusters, or cloud vendor's virtual machines and other compute, which
participate in the service mesh. Each [endpoint provider](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) is responsible for either a particular Kubernetes cluster, or a cloud vendor subscription.
The [Mesh catalog](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#5-mesh-catalog) will query each [Endpoints provider](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) for a particular [service](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#c-service), and obtain the IP addresses and ports of the endpoints handling traffic for service.

The [Endpoints providers](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) are aware of:
...
The [Endpoints providers](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) has no awareness of:
...
> EndpointsProvider. The [Endpoints Providers](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers) are responsible for implementing a method to
...
In the sample `ListEndpointsForService` implementation, the Mesh Catalog loops over a list of [Endpoints providers](https://docs.openservicemesh.io/docs/design_concepts/components_desc/#3-endpoints-providers):
