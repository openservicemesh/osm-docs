...
## Prerequisites
This demo of OSM v0.10.0 requires:
...
Download the 64-bit GNU/Linux or macOS binary of OSM v0.10.0:
```bash
system=$(uname -s)
release=v0.10.0
...
Download the 64-bit Windows OSM v0.10.0 binary via Powershell:
```powershell
wget  https://github.com/openservicemesh/osm/releases/download/v0.10.0/osm-v0.10.0-windows-amd64.zip -o osm.zip
unzip osm.zip
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/apps/bookbuyer.yaml
```

Create the `bookthief` service account and deployment:

```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/apps/bookthief.yaml
```

Create the `bookstore` service account, service, and deployment:

```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/apps/bookstore.yaml
```

Create the `bookwarehouse` service account, service, and deployment:

```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/apps/bookwarehouse.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/access/traffic-access-v1.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/access/traffic-access-v1-allow-bookthief.yaml
```
...
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/apps/bookstore-v2.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/split/traffic-split-v1.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/split/traffic-split-50-50.yaml
```
...
```bash
kubectl apply -f https://raw.githubusercontent.com/openservicemesh/osm/release-v0.10/docs/example/manifests/split/traffic-split-v2.yaml
```
